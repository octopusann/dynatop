...
dynatop <- R6::R6Class(
    ...
    private = list(
        ...
        digest_model = function(model,use_states){
            ...
            ## unpack hillslope and channel sorting by id and hadling states
            ...
            for(ii in c("options","diffuse_inflow","point_inflow","gauge","map")){
                private$model[[ii]] <- model[[ii]]
            }
        ...
        init_hs = function(initial_recharge){
            ...
            q0 <- rep(as.numeric(initial_recharge),length(private$model$hillslope$id))
            switch(private$model$options['transmissivity_profile'],
                   "exponential" = dt_exp_init(private$model$hillslope,
                                               private$model$channel,
                                               private$model$flow_direction,
                                               q0),
                   "exponential_explicit" = dt_exp_init(private$model$hillslope,
                                                        private$model$channel,
                                                        private$model$flow_direction,
                                                        q0),
                   "bounded_exponential" = dt_bexp_init(private$model$hillslope,
                                                       private$model$channel,
                                                       private$model$flow_direction,
                                                       q0),
                   "constant" = dt_cnst_init(private$model$hillslope,
                                             private$model$channel,
                                             private$model$flow_direction,
                                             q0),
        ...
        sim_hs = function(keep_states,sub_step){
            ...
            #browser()
            switch(private$model$options['transmissivity_profile'],
                   "exponential" = dt_exp_courant(private$model$hillslope,
                                                  courant,
                                                  ts$step,
                                                  ts$n_sub_step),
                   "exponential_explicit" = {courant[] <- 0},
                   "bounded_exponential" = dt_bexp_courant(private$model$hillslope,
                                                           courant,
                                                           ts$step,
                                                           ts$n_sub_step),
            ...
            switch(private$model$options['transmissivity_profile'],
                   ...
                   "exponential_explicit" = dt_exp_explicit(private$model$hillslope,
                                                            private$model$channel,
                                                            private$model$flow_direction,
                                                            private$summary$precip_input,
                                                            private$summary$pet_input,
                   ...
                   "bounded_exponential" = dt_bexp_implicit(private$model$hillslope,
                                                            private$model$channel,
                                                            private$model$flow_direction,
                                                            private$summary$precip_input,
                                                            private$summary$pet_input,
                   ...
                   "constant" = dt_cnst_implicit(private$model$hillslope,
                                                 private$model$channel,
                                                 private$model$flow_direction,
                                                 private$summary$precip_input,
                                                 private$summary$pet_input,
